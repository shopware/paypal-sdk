...
namespace Shopware\PayPalSDK\Struct\V1\Disputes\Item\Extensions;

use OpenApi\Attributes as OA;
use Shopware\PayPalSDK\Struct\Struct;
use Shopware\PayPalSDK\Struct\V1\Disputes\Item\Extensions\BillingDisputeProperties\CanceledRecurringBilling;
use Shopware\PayPalSDK\Struct\V1\Disputes\Item\Extensions\BillingDisputeProperties\CreditNotProcessed;
use Shopware\PayPalSDK\Struct\V1\Disputes\Item\Extensions\BillingDisputeProperties\DuplicateTransaction;
use Shopware\PayPalSDK\Struct\V1\Disputes\Item\Extensions\BillingDisputeProperties\IncorrectTransactionAmount;
use Shopware\PayPalSDK\Struct\V1\Disputes\Item\Extensions\BillingDisputeProperties\PaymentByOtherMeans;

#[OA\Schema(schema: 'paypal_v1_disputes_item_extensions_billing_dispute_properties')]
class BillingDisputeProperties extends Struct
{
