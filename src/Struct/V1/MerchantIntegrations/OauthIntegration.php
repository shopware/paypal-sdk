...
use Shopware\PayPalSDK\Struct\V1\MerchantIntegrations\OauthIntegration\OauthThirdParty;
use Shopware\PayPalSDK\Struct\V1\MerchantIntegrations\OauthIntegration\OauthThirdPartyCollection;

#[OA\Schema(
    schema: 'paypal_v1_merchant_integrations_oauth_integration',
    required: ['integrationMethod', 'integrationType', 'oauthThirdParty']
)]
class OauthIntegration extends Struct
{
