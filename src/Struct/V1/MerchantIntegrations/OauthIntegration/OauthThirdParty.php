...
namespace Shopware\PayPalSDK\Struct\V1\MerchantIntegrations\OauthIntegration;

use OpenApi\Attributes as OA;
use Shopware\PayPalSDK\Struct\Struct;

#[OA\Schema(
    schema: 'paypal_v1_merchant_integrations_oauth_integration_oauth_third_party',
    required: ['merchantClientId', 'partnerClientId', 'scopes']
)]
class OauthThirdParty extends Struct
{
