...
use Shopware\PayPalSDK\Struct\V1\Plan\BillingCycle;
use Shopware\PayPalSDK\Struct\V1\Plan\BillingCycleCollection;
use Shopware\PayPalSDK\Struct\V1\Plan\PaymentPreferences;
