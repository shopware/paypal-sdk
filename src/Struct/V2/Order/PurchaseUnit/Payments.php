...
use Shopware\PayPalSDK\Struct\V2\Order\PurchaseUnit\Payments\AuthorizationCollection;
use Shopware\PayPalSDK\Struct\V2\Order\PurchaseUnit\Payments\Capture;
use Shopware\PayPalSDK\Struct\V2\Order\PurchaseUnit\Payments\CaptureCollection;
use Shopware\PayPalSDK\Struct\V2\Order\PurchaseUnit\Payments\Refund;
use Shopware\PayPalSDK\Struct\V2\Order\PurchaseUnit\Payments\RefundCollection;

#[OA\Schema(schema: 'paypal_v2_order_purchase_unit_payments')]
class Payments extends Struct
{
