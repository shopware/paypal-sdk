...
use Shopware\PayPalSDK\Struct\V2\Referral\BusinessEntity\Address;
use Shopware\PayPalSDK\Struct\V2\Referral\BusinessEntity\AddressCollection;

#[OA\Schema(schema: 'paypal_v2_referral_business_entity')]
